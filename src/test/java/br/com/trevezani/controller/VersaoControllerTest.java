...
public class VersaoControllerTest {
    ...
    public void setUp() throws Exception {
        this.base = new URL("http://localhost:" + port + "/versao");
    }
    ...
    public void getVersao() throws Exception {
        ...
        assertThat(response.getBody(), equalTo("v1.00"));
    }
}
